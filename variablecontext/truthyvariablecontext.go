...
func (vc *TruthyVariablecontext) GetVariable(s string) *parameters.VariableParameterValue {
	return nil
}
func (vc *TruthyVariablecontext) SetVariable(s string, v *parameters.VariableParameterValue) {
