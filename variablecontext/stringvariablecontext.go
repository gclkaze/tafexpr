...
func (vc *StringVariableContext) GetVariable(s string) *parameters.VariableParameterValue {
	return nil
}
func (vc *StringVariableContext) FreeVariable(s string) {

}
func (vc *StringVariableContext) SetVariable(s string, v *parameters.VariableParameterValue) {
