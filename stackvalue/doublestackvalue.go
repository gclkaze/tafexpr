...
func (s DoubleStackValue) GetType() StackValueType {
	return DOUBLE
}
...
func (s DoubleStackValue) Copy() StackValue {
	return NewDoubleStackValue(s.value)
}
func (s DoubleStackValue) ToJson() *JSONStackValue {
	return NewJSONStackValue(s.GetValue())
}
func (s DoubleStackValue) Equals(other StackValue) bool {
	if other.GetType() != DOUBLE {
...
func (b DoubleStackValue) Add(s StackValue) (result StackValue, errorType tafargumenetlistenererrortypes.TAFArgumentListenerError, err error) {
	doubleValue := b.value
	switch s.GetType() {
	case JSON_OBJECT:
		{
...
func (b DoubleStackValue) Sub(s StackValue) (result StackValue, errorType tafargumenetlistenererrortypes.TAFArgumentListenerError, err error) {
	doubleValue := b.value
	switch s.GetType() {
	case JSON_OBJECT:
		{
...
func (b DoubleStackValue) Mul(s StackValue) (result StackValue, errorType tafargumenetlistenererrortypes.TAFArgumentListenerError, err error) {
	doubleValue := b.value
	switch s.GetType() {
	case JSON_OBJECT:
		{
...
func (b DoubleStackValue) Div(s StackValue) (result StackValue, errorType tafargumenetlistenererrortypes.TAFArgumentListenerError, err error) {
	doubleValue := b.value
	switch s.GetType() {
	case JSON_OBJECT:
		{
...
func (b DoubleStackValue) Mod(s StackValue) (result StackValue, errorType tafargumenetlistenererrortypes.TAFArgumentListenerError, err error) {
